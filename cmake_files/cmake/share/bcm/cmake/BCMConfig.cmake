...
function(workspace_src WORKSPACE_SOURCE RESULT_NAME)
    string(REPLACE "/cmake_files" "" CMAKE_WORKSPACE_SOURCE ${WORKSPACE_SOURCE})
    set (${RESULT_NAME} ${CMAKE_WORKSPACE_SOURCE} PARENT_SCOPE)
endfunction()

function(workspace_patch SOURCE_TO_PATCH PATCH)
    workspace_src(${CMAKE_SOURCE_DIR} RESULT_NAME)
    string(REPLACE ${RESULT_NAME} ${RESULT_NAME}/patch_files CMAKE_WORKSPACE_SOURCE ${SOURCE_TO_PATCH})
    set (${PATCH} ${CMAKE_WORKSPACE_SOURCE}.patch PARENT_SCOPE)
endfunction()
